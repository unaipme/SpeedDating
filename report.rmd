...
```{r echo=F, fig.cap="\\label{fig:pca-ind-repr}Representation of individuals in first factorial plane", fig.height=3.25, fig.width=4, fig.pos="H", out.extra="", fig.align="center"}
...
```{r echo=F, fig.height=2, fig.cap="\\label{fig:kmeans}Result of k-means with k = [2,6]"}
mar <- par("mar")
